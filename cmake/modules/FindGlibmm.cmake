...
if (GLIBMM_LIBRARIES AND GLIBMM_INCLUDE_DIRS)
    ...
    IF (GLIB_FOUND)
        ...
        FIND_PATH(GLIBMM_INCLUDE_DIR NAMES glibmm.h HINTS ${PC_GLIBMM_INCLUDEDIR} ${PC_GLIBMM_INCLUDE_DIRS})
        FIND_PATH(GLIBMM_CONFIG_INCLUDE_DIR NAMES glibmmconfig.h HINTS ${PC_GLIBMM_INCLUDEDIR} ${PC_GLIBMM_INCLUDE_DIRS})
        FIND_LIBRARY(GLIBMM_LIBRARY NAMES glibmm glibmm-2.0 glibmm-2.4 HINTS ${PC_GLIBMM_LIBDIR} ${PC_GLIBMM_LIBRARY_DIRS})
