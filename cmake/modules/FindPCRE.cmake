...
find_path(PCRE_INCLUDE_DIR pcre.h
          ...
          PATH_SUFFIXES pcre)
message("Found PCRE: Include path is ${PCRE_INCLUDE_DIR}")

find_library(PCRE_PCRE_LIBRARY NAMES pcre$<$<CONFIG:Debug>:d> HINTS ${PC_PCRE_LIBDIR} ${PC_PCRE_LIBRARY_DIRS})
message("Found PCRE: Library name is ${PCRE_PCRE_LIBRARY_NAMES}")

find_library(PCRE_PCREPOSIX_LIBRARY NAMES pcreposix HINTS ${PC_PCRE_LIBDIR} ${PC_PCRE_LIBRARY_DIRS})
message("Found PCRE: Library name is ${PCRE_PCREPOSIX_LIBRARY}")

include(FindPackageHandleStandardArgs)

find_package_handle_standard_args(PCRE DEFAULT_MSG PCRE_INCLUDE_DIR PCRE_PCRE_LIBRARY PCRE_PCREPOSIX_LIBRARY )
set(PCRE_LIBRARIES ${PCRE_PCREPOSIX_LIBRARY} ${PCRE_PCRE_LIBRARY})
message("Found PCRE: Library name is ${PCRE_LIBRARIES}")
