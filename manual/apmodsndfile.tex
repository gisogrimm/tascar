...
\input{oscdoc_tascar_ap_sndfile.tex}

All parameters (\verb!/loop!, \verb!/mute!, \verb!/position!,
\verb!/rampend!, \verb!/rampstart! and \verb!/start!) will affect the
file which is loaded next. It will not affect the current file.
