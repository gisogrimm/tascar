...
\hline
\indattr{id} & Unique route id, empty to autogenerate (string) & 2a\\
\hline
...
\hline
\indattr{prefaderlevel} & Use pre-fader level metering (bool) & false\\
\hline
\indattr{solo} & Solo flag of route (bool) & false\\
\hline
\indattr{use\_leq} & Use Leq in level metering (true) or exponential decay (false) (bool) & true\\
\hline
\end{tabularx}
}
\end{snugshade}
