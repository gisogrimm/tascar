...
To achieve best performance for delay-critical setups, it is recommended to optimise the operating system. Below you will find some hints for such optimisations on debian-based Linux operating systems. To test the current system, you may use the script \verb!tascar_assertrt!.
